...
<link rel="stylesheet" media="screen and (max-width:900px)" href="<?php echo base_url('static/css/small.css'); ?>" type="text/css" />
...
<body>
	...
	<div class="top">
        ...
        <div class="top_small_nav" style="margin-top:200px;">
            <a href="<?php echo base_url('about?aid=1');?>">公司概况</a>
            <a href="<?php echo base_url('navigcontrol/?tid=8');?>">新闻动态</a>
            <a href="<?php echo base_url('navigcontrol/?tid=11');?>">业务介绍</a>  	
            <div class="cl"></div>
